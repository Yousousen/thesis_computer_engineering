...
% TODO Explain structure of the report
...
% TODO: livelock and deadlock defintions in terms of automata theory.
...
% TODO: Replace with self made figures.
\begin{figure}[H]
    \centering
...
% TODO: For discussion, mention how this only mitigates the problem of accessing non real-time drivers. For hard real-time performance, instead of using an XDDP port to write to a nrt thread, the LED driver should be ported to the xenomai driver to operate in real-time.
...
% TODO: In discussion, maybe discuss the possibility of delays that could come up here.
\par
...
\label{Latency tests}
% TODO: What a latency test is and why it is useful
% TODO: Talk about in microseconds, 20 seconds test, what is highlighted.
