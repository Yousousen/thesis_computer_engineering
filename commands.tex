...
\newcommand{\sqtwo}{How can sensor data be retrieved and how can sensor data be used to check for unsafe behavior?}
...
\newcommand{\sqfour}{How can the safety module be implemented, using the formal specifcation, on a real-time operating system?}